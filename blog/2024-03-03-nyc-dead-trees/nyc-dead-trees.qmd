...
nyc_trees <- st_read("~/MEDS_FOLDER/hazelvaq.github.io/data/tree_data/geo_export_145e1dbe-8d16-4451-aa07-a8915754603a.shp")

# Read in NYC boundary
nyc_boundary <- st_read("~/MEDS_FOLDER/hazelvaq.github.io/data/nyc_boundary/geo_export_cba87a71-9b4b-45bc-9ca2-8cd5cf2eabdb.shp")
```
...
# View the distribution of the diameters
summary(d1)
...
p3 <- ggplot(data = diameters) +
  ...
  geom_text(aes(x = x0, y = -3, label = range), color = "black", size = 5, fontface = "bold") +
...
# Save plot
# ggsave("plots/p3.png", bg = "transparent",width = 15, height = 10)
